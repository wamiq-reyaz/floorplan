...
from rplan import RplanConstrained
...
if __name__ == '__main__':
    ...
    if args.dataset == 'rplan':
        ...
        val_set = RplanConstrained(root_dir=args.datapath,
                              split='val',
                              enc_len=args.enc_n,
                              dec_len=args.dec_n,
                              vocab_size=args.vocab,
    ...
    ## Basic logging
    SAVE_LOCATION = args.root_dir + f'models/constr/' + run_id + '/'
    ...
    for epochs in range(args.epochs):
        ...
        torch.save(model.state_dict(), SAVE_LOCATION + f'model_constr.pth')
        ...
        if total_nll < best_nll:
            best_nll = total_nll
            torch.save(model.state_dict(), SAVE_LOCATION + f'model_constr_best.pth')
