...
if __name__ == '__main__':
    ...
    # optimizer
    parser.add_argument('--step', default=30, type=int, help='how many epochs before reducing lr')
    ...
    run_id = "GraphGPT-{}----adj_{}-bs{}-lr{:0.5f}-enl{}-decl{}-dim_embed{}-{}".format(dt.now().strftime('%d-%h_%H-%M'),
                                                                                       args.adj,
