...
from rplan import RrplanGraph, Flip, Rot90,RplanConditionalGraph, LIFULLConditionalGraph
...
if __name__ == '__main__':
    ...
    if args.dataset == 'rplan':
        ...
        dset = RplanConditionalGraph(root_dir=args.datapath,
                     split='train',
                     enc_len=args.enc_n,
                     dec_len=args.dec_n,
        ...
        val_set = RplanConditionalGraph(root_dir=args.datapath,
                              split='val',
                              enc_len=args.enc_n,
                              dec_len=args.dec_n,
                              vocab_size=args.vocab,
        ...
        dset = LIFULLConditionalGraph(root_dir=args.datapath,
                     split='train',
                     enc_len=args.enc_n,
                     dec_len=args.dec_n,
                     drop_dim=args.tuples == 3,
        ...
        val_set = LIFULLConditionalGraph(root_dir=args.datapath,
                              split='val',
                              enc_len=args.enc_n,
                              dec_len=args.dec_n,
                              vocab_size=args.vocab,
