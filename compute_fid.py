...
if __name__ == '__main__':
    ...
    if compute_stats:
        ...
        result_sets = [
            ...
            {'room_basepath': '../data/results/housegan_on_lifull_rooms/housegan_on_lifull', 'out_filename': '../data/results/housegan_on_lifull_stats/inceptionv3_stats.npz'},
        ]
    ...
    if compute_stat_distances:
        ...
        stat_dist_sets = [
            ...
            {'real_stat_filename': '../data/results/gt_on_lifull_stats/inceptionv3_stats.npz', 'fake_stat_filename': '../data/results/housegan_on_lifull_stats/inceptionv3_stats.npz'},
        ]
